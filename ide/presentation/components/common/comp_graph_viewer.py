...
class CompGraphViewer(QGraphicsView):
    ...
    def set_graph(self: "CompGraphViewer", graph: Any) -> None:
    ...
    def _svg_to_pixmap(self: "CompGraphViewer", svg_data: str) -> Optional[QPixmap]:
    ...
    def _display_pixmap(self: "CompGraphViewer", pixmap: QPixmap) -> None:
    ...
    def wheelEvent(self: "CompGraphViewer", event: QWheelEvent) -> None:  # type: ignore[override]
    ...
    def mousePressEvent(self: "CompGraphViewer", event: QMouseEvent) -> None:  # type: ignore[override]
    ...
    def mouseMoveEvent(self: "CompGraphViewer", event: QMouseEvent) -> None:  # type: ignore[override]
    ...
    def mouseReleaseEvent(self: "CompGraphViewer", event: QMouseEvent) -> None:  # type: ignore[override]
    ...
    def clear_graph(self: "CompGraphViewer") -> None:
    ...
    def fit_in_view(self: "CompGraphViewer") -> None:
    ...
    def reset_zoom(self: "CompGraphViewer") -> None:
